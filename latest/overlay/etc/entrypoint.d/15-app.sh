...
declare -x KANBOARD_MAIL_BCC
[[ -z "${KANBOARD_MAIL_BCC}" ]] && KANBOARD_MAIL_BCC=""
...
declare -x KANBOARD_MAIL_SMTP_HELO_NAME
[[ -z "${KANBOARD_MAIL_SMTP_HELO_NAME}" ]] && KANBOARD_MAIL_SMTP_HELO_NAME=""
...
declare -x KANBOARD_LDAP_USER_DEFAULT_ROLE_MANAGER
[[ -z "${KANBOARD_LDAP_USER_DEFAULT_ROLE_MANAGER}" ]] && KANBOARD_LDAP_USER_DEFAULT_ROLE_MANAGER="false"
...
declare -x KANBOARD_LDAP_GROUP_USER_ATTRIBUTE
[[ -z "${KANBOARD_LDAP_GROUP_USER_ATTRIBUTE}" ]] && KANBOARD_LDAP_GROUP_USER_ATTRIBUTE="username"

declare -x KANBOARD_LDAP_GROUP_ATTRIBUTE_NAME
[[ -z "${KANBOARD_LDAP_GROUP_ATTRIBUTE_NAME}" ]] && KANBOARD_LDAP_GROUP_ATTRIBUTE_NAME="cn"

declare -x KANBOARD_LDAP_GROUP_SYNC
[[ -z "${KANBOARD_LDAP_GROUP_SYNC}" ]] && KANBOARD_LDAP_GROUP_SYNC="true"
...
declare -x KANBOARD_REVERSE_PROXY_EMAIL_HEADER
[[ -z "${KANBOARD_REVERSE_PROXY_EMAIL_HEADER}" ]] && KANBOARD_REVERSE_PROXY_EMAIL_HEADER="REMOTE_EMAIL"

declare -x KANBOARD_REVERSE_PROXY_FULLNAME_HEADER
[[ -z "${KANBOARD_REVERSE_PROXY_FULLNAME_HEADER}" ]] && KANBOARD_REVERSE_PROXY_FULLNAME_HEADER="REMOTE_NAME"
...
declare -x KANBOARD_SESSION_HANDLER
[[ -z "${KANBOARD_SESSION_HANDLER}" ]] && KANBOARD_SESSION_HANDLER="db"
...
declare -x KANBOARD_HTTP_PROXY_EXCLUDE
[[ -z "${KANBOARD_HTTP_PROXY_EXCLUDE}" ]] && KANBOARD_HTTP_PROXY_EXCLUDE="localhost"
...
declare -x KANBOARD_SHOW_GROUP_MEMBERSHIPS_IN_USERLIST
[[ -z "${KANBOARD_SHOW_GROUP_MEMBERSHIPS_IN_USERLIST}" ]] && KANBOARD_SHOW_GROUP_MEMBERSHIPS_IN_USERLIST="true"

declare -x KANBOARD_SHOW_GROUP_MEMBERSHIPS_IN_USERLIST_WITH_LIMIT
[[ -z "${KANBOARD_SHOW_GROUP_MEMBERSHIPS_IN_USERLIST_WITH_LIMIT}" ]] && KANBOARD_SHOW_GROUP_MEMBERSHIPS_IN_USERLIST_WITH_LIMIT="7"

declare -x KANBOARD_DASHBOARD_MAX_PROJECTS
[[ -z "${KANBOARD_DASHBOARD_MAX_PROJECTS}" ]] && KANBOARD_DASHBOARD_MAX_PROJECTS="10"

declare -x KANBOARD_DB_DRIVER
[[ -z "${KANBOARD_DB_DRIVER}" ]] && KANBOARD_DB_DRIVER="sqlite"

declare -x KANBOARD_DB_TIMEOUT
[[ -z "${KANBOARD_DB_TIMEOUT}" ]] && KANBOARD_DB_TIMEOUT=""

declare -x KANBOARD_DB_ODBC_DSN
[[ -z "${KANBOARD_DB_ODBC_DSN}" ]] && KANBOARD_DB_ODBC_DSN="kanboard"
