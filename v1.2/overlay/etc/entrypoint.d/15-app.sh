...
declare -x REVERSE_PROXY_EMAIL_HEADER
[[ -z "${REVERSE_PROXY_EMAIL_HEADER}" ]] && REVERSE_PROXY_EMAIL_HEADER="REMOTE_EMAIL"

declare -x REVERSE_PROXY_FULLNAME_HEADER
[[ -z "${REVERSE_PROXY_FULLNAME_HEADER}" ]] && REVERSE_PROXY_FULLNAME_HEADER="REMOTE_NAME"
